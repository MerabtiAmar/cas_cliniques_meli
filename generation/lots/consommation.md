# Consommation réelle par lot (équivalent API, `python generation/consommation.py`)

Objectif : environ 1,2 $ par cas au format compact (PLAN_60.md). Calibrage de l'abonnement Pro : fenêtre de 5 h ≈ 30 $, semaine ≈ 215 $.

| Lot | Génération | Vérification croisée | Total | Par cas | Remarque |
|---|---|---|---|---|---|
